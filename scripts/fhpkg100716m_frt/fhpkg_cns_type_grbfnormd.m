function varargout = fhpkg_cns_type_grbfnormd(method, varargin)

% Defines the "grbfnormd" cell type.  This is a subtype of "sd" which computes responses using a normalized Gaussian
...
% Add "grbfnormd" group G, defined by parameters P and dictionary D, to a network model.  Called from fhpkg_model via
