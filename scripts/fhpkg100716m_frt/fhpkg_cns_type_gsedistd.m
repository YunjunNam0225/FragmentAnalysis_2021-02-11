function varargout = fhpkg_cns_type_gsedistd(method, varargin)

% Defines the "gsedistd" cell type.  This is a subtype of "sd" which computes responses using squared Euclidean distance.
