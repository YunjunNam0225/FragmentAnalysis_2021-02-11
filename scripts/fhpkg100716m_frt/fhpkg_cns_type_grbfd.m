function varargout = fhpkg_cns_type_grbfd(method, varargin)

% Defines the "grbfd" cell type.  This is a subtype of "sd" which computes responses using a Gaussian RBF.
