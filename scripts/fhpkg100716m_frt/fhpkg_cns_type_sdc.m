function varargout = fhpkg_cns_type_sdc(method, varargin)

% Defines the "sdc" cell type.  An "sdc" cell computes the response of a patch of cells in the previous layer to a stored
% (learned) template of the same size.  The "d" stands for "dense" -- the stored templates contain values for every
% feature at every position. The "c" stands for "customized".
%
