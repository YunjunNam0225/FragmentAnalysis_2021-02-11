...
void _CopyTex(float *dBuf, unsigned int dHeight, char dest, _TexPtrA &ta, _TexPtrB &tb, unsigned int yOff,
...
void _UpdateTex(_TexPtrA &ta, _TexPtrB &tb, unsigned int yOff, unsigned int xOff, const float *sBuf,
